...
const std::string c_use_vi_vc = "use_vi_vc";
const std::string c_use_vi_vr = "use_vi_vr";
const std::string c_use_vi_hc1_full = "use_vi_hc1_full";
const std::string c_use_vi_hc1_half = "use_vi_hc1_half";
const std::string c_use_vi_hc1_quarter = "use_vi_hc1_quarter";
const std::string c_use_vi_hc2 = "use_vi_hc2";
const std::string c_use_vi_hc3 = "use_vi_hc3";
const std::string c_use_vi_cos = "use_vi_cos";
const std::string c_use_vi_qua = "use_vi_qua";
const std::string c_use_vi_cus = "use_vi_cus";
const std::string c_use_vi_lex_full = "use_vi_lex_full";
const std::string c_use_vi_lex_half = "use_vi_lex_half";
const std::string c_use_vi_lex_quarter = "use_vi_lex_quarter";
...
void ConfigParameters::setupParameters()
{
    ...
    // ---- Valid inequalities ----
    mModelParam.useVIVC_ = parseBool(mData[c_use_vi_vc]);
    mModelParam.useVIVR_ = parseBool(mData[c_use_vi_vr]);
    mModelParam.useVIHC1Full_ = parseBool(mData[c_use_vi_hc1_full]);
    mModelParam.useVIHC1Half_ = parseBool(mData[c_use_vi_hc1_half]);
    mModelParam.useVIHC1Quarter_ = parseBool(mData[c_use_vi_hc1_quarter]);
    mModelParam.useVIHC2_ = parseBool(mData[c_use_vi_hc2]);
    mModelParam.useVIHC3_ = parseBool(mData[c_use_vi_hc3]);
    mModelParam.useVICOS_ = parseBool(mData[c_use_vi_cos]);
    mModelParam.useVIQUA_ = parseBool(mData[c_use_vi_qua]);
    mModelParam.useVICUS_ = parseBool(mData[c_use_vi_cus]);
    mModelParam.useVILEXFull_ = parseBool(mData[c_use_vi_lex_full]);
    mModelParam.useVILEXHalf_ = parseBool(mData[c_use_vi_lex_half]);
    mModelParam.useVILEXQuarter_ = parseBool(mData[c_use_vi_lex_quarter]);
}